...
Второй раз один и тот же прием — сначала собрать все в одно место, потом наложить ось времени — дает эффект связности. С [заметками](https://habr.com/ru/articles/1024824/) я получил не только удобство, но и возможность ретроспективы. С архивом — не только порядок, но и таймлайн фотографий.
