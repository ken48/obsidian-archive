...
Таймлайн делает с фотографиями то, чего не делает ни один альбом. В обычном альбоме снимки сгруппированы по событиям или по людям. Смотришь "вот наша поездка", "вот бабушка в молодости"... В таймлайне эти детали исчезают, и остается одна ось — время.
...
Второй раз подряд один и тот же простой прием — сначала собрать все в одно место, потом наложить ось времени — дает этот эффект связности. С [заметками](https://habr.com/ru/articles/1024824/) я получил не только удобство, но и возможность ретроспективы. С архивом — не только порядок, но и таймлайн фотографий.
