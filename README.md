...
Второй раз один и тот же прием — сначала собрать все в одно место, потом наложить ось времени — дает эффект связности. С [заметками](https://github.com/ken48/obsidian-notes) это было не только удобство создания, но и возможность ретроспективы. С архивом — не только порядок, но и таймлайн фотографий.
